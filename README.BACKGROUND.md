...
Like many others, I've been enamored by the Gas Town metaphors for software engineering workflow. Crew working on rigs, consuming guzzoline, slinging work to polecats... yeah, this is right up my alley.
...
To be clear none of this is a dis or dunk on gastown - it's an ambitious project that is going to take time to mature. This is a snapshot of some of the problems that I observe today in Feb 2026.
...
4. Check on status with with `rig work status`: this shows you where work is at on all your rigs.
